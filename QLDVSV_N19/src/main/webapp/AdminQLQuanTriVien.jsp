					...
					<div class="card">
						<div class="card-body">
							<table class="table table-striped" id="table1">
								...
								<tbody>
									<tr>
										<c:forEach var="qtv" items="${listQTV}">
											<tr>
												<td><c:out value="${qtv.getMSQT()}" /></td>
												<td><c:out value="${qtv.getHo()}" /> <c:out
														   value="${qtv.getTenDem()}" /> <c:out
														   value="${qtv.getTen()}" /></td>
												<td><c:out value="${qtv.getSdt()}" /></td>
											</tr>
										</c:forEach>
