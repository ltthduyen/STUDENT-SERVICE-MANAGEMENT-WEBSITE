            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item ">
                            <a href="GXN?action=list&id=${taikhoan}&email=${email}" class='sidebar-link'>
                                <i class="bi bi-grid-fill"></i>
							...
							<table class="table table-striped" id="table1">
								...
								<tbody>
									<c:forEach var="cv" items="${listChuyenVien}">
											<tr>
												<td><c:out value="${cv.getMSCTSV()}" /></td>
												<td><c:out value="${cv.getHo()}" /> <c:out
														   value="${cv.getTenDem()}" /> <c:out
														   value="${cv.getTen()}" /></td>
												<td><c:out value="${cv.getSdt()}" /></td>
											</tr>
										</c:forEach>
								</tbody>
							</table>
